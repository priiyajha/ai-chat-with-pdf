...
const features = [
    ...
    },
    {
        ...
        description: "Engage with your PDFs like never before using our ntutive and interactive viewer.",
        icon: EyeIcon,
    },
    {
        name: "Cloud Backup",
    ...
    },
    {
        ...
        description: "Access and chat with your PDF seamlessly from any device, whether it's your desktop, tablet or smartphone.",
