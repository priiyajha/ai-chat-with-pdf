            ...
            <div className="py-24 sm:py-32">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
                        Supercharge your PDF Conversations!
                    </p>
                </div>
                <p className="mx-auto mt-6 max-w-2xl px-10 text-center text-lg leading-8 text-gray-600">
                    Choose the best plan for you to interact with your PDFs.
                    Choas to Clarity made easy.
                ...
                <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-w-4xl">
                    ...
                    <div className="ring-2 ring-indigo-600 rounded-3xl p-8">
                        ...
                        <p className="mt-4 text-sm leading-6 text-gray-600">
                            Maximize your productivity with our PRO Features!
                        </p>
                        <p className="mt-6 flex items-baseline gap-x-1">
                            <span className="text-4xl font-bold tracking-tight text-gray-900">$3.99</span>
